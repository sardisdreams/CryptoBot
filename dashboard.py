...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header { background: #252d45; border-bottom: 1px solid #4d5e72;
  ...
  .ver { background: #6366f122; color: #818cf8; border: 1px solid #6366f144;
         padding: 3px 10px; border-radius: 20px; font-size: 0.72rem; font-weight: 600; }
  /* Tabs */
  .tabs { display: flex; gap: 0; border-bottom: 1px solid #4d5e72;
          background: #252d45; padding: 0 32px; }
  ...
  .card { background: #252d45; border: 1px solid #4d5e72; border-radius: 10px; padding: 14px 16px; }
  ...
  .neg { color: #ef4444; }
  .warn{ color: #f59e0b; }
  .section { background: #252d45; border: 1px solid #4d5e72; border-radius: 10px;
  ...
  th { text-align: left; padding: 7px 9px; color: #475569; font-weight: 600;
       font-size: 0.68rem; text-transform: uppercase; border-bottom: 1px solid #4d5e72; }
  td { padding: 9px 9px; border-bottom: 1px solid #374155; color: #e2e8f0; vertical-align: top; }
  tr:last-child td { border-bottom: none; }
  tr:hover td { background: #2d3550; }
...
<div class="container">
  ...
  <div class="grid grid-pos">
    ...
    <div class="card" style="{% if p.gain_loss_pct >= 0 %}background:#22c55e12;border-color:#22c55e33;{% else %}background:#ef444412;border-color:#ef444433;{% endif %}">
      <div class="label">
