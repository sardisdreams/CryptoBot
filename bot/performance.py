...
TIERS = [
    (-999999, "CONSERVE",  3600, 5.0, False),  # loss or flat   → 60min, Sonnet at 5%+
    (10,      "CAUTIOUS",  2700, 4.0, False),  # +$10           → 45min, Sonnet at 4%+
    (50,      "ACTIVE",    1800, 3.0, False),  # +$50           → 30min, Sonnet at 3%+
    (100,     "AGGRESSIVE",1200, 2.0, False),  # +$100          → 20min, Sonnet at 2%+
